...
<html>
    <head>
        ...
        <link rel="stylesheet" href="adminstule.css">
    ...
    <body>
        ...
        <input type="email"  name="addemail" ><br>

        <label >Password:</label><br>
        <input type="password"  name="addpass" ><br>
        ...
        <input type="submit" value="Submit">
            ...
            <label>Book Name:</label><br><input type="text" name="bookname"/>
            <br>
            <label>Detail:</label><br><input  type="text" name="bookdetail"/><br>
            <label>Autor:</label><br><input type="text" name="bookauthor"/><br>
            <label>Publication</label><br><input type="text" name="bookpub"/><br>
            <div><label>Branch:</label><br><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="ECE" style="margin-left:80px"/>ECE<div><input type="radio" name="branch" value="CSE"/>CSE<input type="radio" name="branch" value="MECH" style="margin-left:80px"/>MECH</div>
            </div>   
            <label>Price:</label><br><input  type="number" name="bookprice"/><br>
            <label>Quantity:</label><br><input type="number" name="bookquantity"/><br>
            <label>Book Photo</label><br><input  type="file" name="bookphoto"/><br>
            <br>
    ...
    <div class="rightinnerdiv">   
            ...
            <label>Book Name:</label><br><input type="text" name="bookname"/><br>
            <label>Autor:</label><br><input type="text" name="bookauthor"/><br>
            <label>Publication</label><br><input type="text" name="bookpub"/><br>
            <label>Date:</label><br><input type="date" name="issuedate"/><br>
            <br>
